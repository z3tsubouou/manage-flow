	...
	return (
		<>
			<Dropdown
				...
				<DropdownMenu variant="bordered" aria-label="Dropdown menu with description">
					<DropdownSection title="Actions">
						<DropdownItem key="edit" startContent={<Edit />} onClick={() => onEditOpen()}>
							Edit category
						</DropdownItem>
					</DropdownSection>
			...
			<BookmarkDeleteModal isOpen={isDeleteOpen} onOpenChange={onDeleteOpenChange} />
		</>
	);
};
